...
// GetCommandCodeKeys fetches Command Code API keys.
func (c *Client) GetCommandCodeKeys() ([]map[string]any, error) {
	return c.getWrappedKeyList("/v0/management/commandcode-api-key", "commandcode-api-key")
}
