...
// Stop closes listeners and gracefully drains active HTTP requests.
//
// Parameters:
//   - ctx: Context bounding the graceful shutdown.
//
// Returns:
...
func (s *Server) Stop(ctx context.Context) error {
	...
	// Preserve the fork shutdown contract: allow active HTTP requests to drain.
