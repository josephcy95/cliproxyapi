...
var managementRouteContract = []struct {
	...
	{http.MethodGet, "/v0/management/desensitization-config"},
	{http.MethodPut, "/v0/management/desensitization-config"},
	{http.MethodPatch, "/v0/management/desensitization-config"},
	{http.MethodPost, "/v0/management/desensitization/preview"},
	...
	// Command Code credentials (provided by the fork; consumed by the
	// Management Center providers page).
	{http.MethodGet, "/v0/management/commandcode-api-key"},
	{http.MethodPut, "/v0/management/commandcode-api-key"},
	{http.MethodPatch, "/v0/management/commandcode-api-key"},
	{http.MethodDelete, "/v0/management/commandcode-api-key"},
	...
	{http.MethodGet, "/v0/management/plugins/:id/quota"},
	{http.MethodPost, "/v0/management/plugins/:id/quota"},
	{http.MethodDelete, "/v0/management/plugins/:id/quota"},
	{http.MethodPost, "/v0/management/plugins/:id/quota/reset"},
	{http.MethodGet, "/v0/management/meta-api-key"},
	{http.MethodPut, "/v0/management/meta-api-key"},
	{http.MethodPatch, "/v0/management/meta-api-key"},
	{http.MethodDelete, "/v0/management/meta-api-key"},
	{http.MethodGet, "/v0/management/oauth-request-scoped-errors"},
	{http.MethodPut, "/v0/management/oauth-request-scoped-errors"},
	{http.MethodPatch, "/v0/management/oauth-request-scoped-errors"},
	{http.MethodDelete, "/v0/management/oauth-request-scoped-errors"},
	{http.MethodGet, "/v0/management/devin-auth-url"},
	{http.MethodGet, "/v0/management/meta-auth-url"},
